...
func (m *mockL2Chain) RPCURL() string                                  { return "http://localhost:8545" }
func (m *mockL2Chain) Client() (*sources.EthClient, error)             { return nil, nil }
func (m *mockL2Chain) GethClient() (*ethclient.Client, error)          { return nil, nil }
func (m *mockL2Chain) ID() types.ChainID                               { return types.ChainID(big.NewInt(1)) }
func (m *mockL2Chain) ContractsRegistry() interfaces.ContractsRegistry { return nil }
func (m *mockL2Chain) Wallets() system.WalletMap {
	return m.wallets
}
func (m *mockL2Chain) GasPrice(ctx context.Context) (*big.Int, error) {
	return big.NewInt(1), nil
}
func (m *mockL2Chain) GasLimit(ctx context.Context, tx system.TransactionData) (uint64, error) {
	return 1000000, nil
}
func (m *mockL2Chain) PendingNonceAt(ctx context.Context, address common.Address) (uint64, error) {
	return 0, nil
}
func (m *mockL2Chain) SupportsEIP(ctx context.Context, eip uint64) bool {
	return true
}
func (m *mockL2Chain) Config() (*params.ChainConfig, error) {
	if m.config == nil {
		return nil, fmt.Errorf("chain config not implemented")
	}
	return m.config, nil
}
func (m *mockL2Chain) Node() system.Node {
	return newMockNode(m.config)
}
func (m *mockL2Chain) L1Addresses() system.AddressMap {
	return system.AddressMap{}
}
func (m *mockL2Chain) Addresses() system.AddressMap {
	return system.AddressMap{}
}
